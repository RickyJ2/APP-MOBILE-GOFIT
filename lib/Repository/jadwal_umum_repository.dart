...
class JadwalUmumRepository {
  ...
  Future<void> add(JadwalUmum jadwalUmum) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw const HttpException('Failed to add jadwal umum');
    }
  }
  ...
  Future<void> update(JadwalUmum jadwalUmum) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw const HttpException('Failed to update jadwal umum');
    }
  }
  ...
  Future<void> delete(int id) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw const HttpException('Failed to delete Jadwal Umum');
    }
  }
}
